...
(function() {
    CKEDITOR.plugins.add("language", {
        requires: "menubutton",
        lang: "ar,az,bg,ca,cs,cy,da,de,de-ch,el,en,en-au,en-gb,eo,es,es-mx,et,eu,fa,fi,fo,fr,gl,he,hr,hu,id,it,ja,km,ko,ku,lv,nb,nl,no,oc,pl,pt,pt-br,ro,ru,sk,sl,sq,sv,tr,tt,ug,uk,vi,zh,zh-cn", // Thêm vi (Tiếng Việt)
        icons: "language",
        hidpi: !0,
        init: function(a) {
            var b = a.config.language_list || ["ar:Arabic:rtl", "vi:Vietnamese", "fr:French", "es:Spanish"], // Thêm vi vào danh sách ngôn ngữ
                c = this,
                d = a.lang.language,
                e = {},
                g, h, k, f;
